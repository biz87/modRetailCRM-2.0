...
$_lang['setting_modretailcrm_siteCode_desc'] = 'Символьный код сайта, кодовое обозначение вашего сайта, сохраненное в настройках RetailCRM (Раздел Администрирование-Магазины)';

$_lang['setting_modretailcrm_url'] = 'Адрес Вашей CRM';
$_lang['setting_modretailcrm_url_desc'] = 'Уникальный адрес вашей CRM, сформированный при регистрации, например https://minishop2.retailcrm.ru';
...
$_lang['setting_modretailcrm_setting_modretailcrm_sync_statuses_desc'] = 'Через запятую id статусов заказов, которые нужно синхронизировать. <br> Важно каждому статусу нужно задать соответствующий символьный код в настройках minishop';

$_lang['setting_modretailcrm_allow_msoptionsprice'] = 'Используете msOptionsPrice2 ?';
$_lang['setting_modretailcrm_allow_msoptionsprice_desc'] = 'Влияет на XML разметку для выгрузки товаров в RetailCRM, используется в передаче заказов';

$_lang['setting_modretailcrm_custom_orders_class'] = 'Собственный класс заказов';
$_lang['setting_modretailcrm_custom_orders_class_desc'] = 'JSON массив данных о собственном классе заказа. Подробнее в документации';
